import { EditUseCase, type IEditDTO } from "@/app/useCases/edit.useCase.js";
import { BaseCommand } from "@/infra/commands/base.command.js";
import { editPrompt } from "@/infra/prompts/account/edit.prompt.js";
import { selectPrompt } from "@/infra/prompts/account/select.prompt.js";
import { editValidator } from "@/infra/validators/account/edit.validator.js";
